...
This project is indexed by GitNexus as **deskclock-tauri** (6278 symbols, 15003 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
