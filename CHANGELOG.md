...
* add 'Concluir' button to planned tasks in popup flyout ([2eed540](https://github.com/Coaktion/deskclock-tauri/commit/2eed540907af572ba2760a8f1f49bc528ab1c0f5))
* add Integrations tour (5 steps) ([ec7cade](https://github.com/Coaktion/deskclock-tauri/commit/ec7cadedbf345dc6933e1ccb63df6e16f241479b))
* add interactive tour system with Driver.js (Tasks screen) ([0657f4d](https://github.com/Coaktion/deskclock-tauri/commit/0657f4d2a278ba8ffb3c265fe0c4dbb90ab6d553))
* add Planning tour (4 steps) ([b2a3a45](https://github.com/Coaktion/deskclock-tauri/commit/b2a3a45502b7f95f8c2c6b05f9e2ac8410be5d1d))
* add Retroactive tour (4 steps) ([62b1aaa](https://github.com/Coaktion/deskclock-tauri/commit/62b1aaa29785058a171d1b579cb58caf3d5e1aea))
* add right rail with shortcuts to configured integrations ([081e9ad](https://github.com/Coaktion/deskclock-tauri/commit/081e9adcb225539ff23771bb5568f33387501ea6))
* **calendar:** import por período livre, pré-mapeamento e lançamento retroativo via planejadas ([6ebdcba](https://github.com/Coaktion/deskclock-tauri/commit/6ebdcbadc91447146895c19223b2352a26be8c62))
* edit end time when stopping task from popup flyout ([f82a38b](https://github.com/Coaktion/deskclock-tauri/commit/f82a38bb2ba2d7162120f51e2d8642613e747f45))
* implement deskclock:// deep link URL scheme ([7b5ebba](https://github.com/Coaktion/deskclock-tauri/commit/7b5ebbab05987235c706636e7a29bba36209083f))
* retroactive tour — add duration field step (natural language formats) ([0de91c8](https://github.com/Coaktion/deskclock-tauri/commit/0de91c800aea136282e380a2a965551f539439d1))
* show planned task actions as clickable chips instead of auto-executing ([b55ed4f](https://github.com/Coaktion/deskclock-tauri/commit/b55ed4f3cdd248935f0f0607483982180fe03283))


### Bug Fixes

* adds loadAll on the return from the makeRepo factory ([e5c7d31](https://github.com/Coaktion/deskclock-tauri/commit/e5c7d31df0d24b2935dc45cf26f2314fa15d65bb))
* **calendar:** mover dica de metadados para o acordeão de integração e corrigir tratamento de erro ([614d922](https://github.com/Coaktion/deskclock-tauri/commit/614d9228f76bdbe7d4abd3c7fd91f1470769bdbe))
* **overlay:** preserva plannedTaskId ao parar tarefa via popup ([01e4f26](https://github.com/Coaktion/deskclock-tauri/commit/01e4f26bfc6814a3e528bb4d5a71582172a7a9d4))
* planning page reacts to planned-task changes from other windows ([ddde395](https://github.com/Coaktion/deskclock-tauri/commit/ddde395ecf5bdf5db37a713514de3a2ab447ba79))
* planning tour — expand step 1 text, fix day filter overflow clipping ([91f8b36](https://github.com/Coaktion/deskclock-tauri/commit/91f8b36c36086c9b9cd9c2c2b8bd134277b1f973))
* **sheets:** block manual sync while daily auto-sync is running ([d4c69af](https://github.com/Coaktion/deskclock-tauri/commit/d4c69affb6711633339c7bdf60fd3035b5c9dd15))
* tour — add padding and margin-right to skip button ([91ba900](https://github.com/Coaktion/deskclock-tauri/commit/91ba900b17d027244f31c4003d2a18f9baa0b200))
* tour — remove text-shadow, fix omnibox step text, add skip button ([4b7a461](https://github.com/Coaktion/deskclock-tauri/commit/4b7a461d74ed0c415b339ae43e9fcafb75fccb75))
