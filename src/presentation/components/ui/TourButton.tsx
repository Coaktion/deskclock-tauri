 ...
 * Clockify — quatro cópias de um botão de 22px, que é justamente o tamanho em
...
export function TourButton({
  ...
  return (
    <button
      ...
      title={label}
      aria-label={label}
      className="size-5.5 shrink-0 rounded-full border border-border text-fg-muted hover:border-fg-muted hover:text-fg-secondary transition-colors text-micro font-medium flex items-center justify-center"
    >
      ?
    </button>
  );
