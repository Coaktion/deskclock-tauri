...
- **A importação da Agenda é exceção deliberada**: o `getMondayISO` do `ImportCalendarModal` fixa a segunda porque a semana daquela tela começa na segunda e conta dali — cinco dias, ou sete com "Exibir fim de semana" ligada. A chave precisa ser a segunda nos dois modos e nas duas larguras.
